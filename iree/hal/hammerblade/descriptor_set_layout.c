...
typedef struct iree_hal_hammerblade_descriptor_set_layout_t {
  iree_hal_resource_t resource;
  iree_hal_hammerblade_context_wrapper_t* context;
  iree_host_size_t binding_count;
} iree_hal_hammerblade_descriptor_set_layout_t;

extern const iree_hal_descriptor_set_layout_vtable_t
    iree_hal_hammerblade_descriptor_set_layout_vtable;

static iree_hal_hammerblade_descriptor_set_layout_t*
iree_hal_hammerblade_descriptor_set_layout_cast(
    iree_hal_descriptor_set_layout_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_hal_hammerblade_descriptor_set_layout_vtable);
  return (iree_hal_hammerblade_descriptor_set_layout_t*)base_value;
}
...
iree_status_t iree_hal_hammerblade_descriptor_set_layout_create(
  ...
  *out_descriptor_set_layout = NULL;
  ...
  iree_hal_hammerblade_descriptor_set_layout_t* descriptor_set_layout = NULL;
  ...
  if (iree_status_is_ok(status)) {
    iree_hal_resource_initialize(&iree_hal_hammerblade_descriptor_set_layout_vtable,
...
iree_host_size_t iree_hal_hammerblade_descriptor_set_layout_binding_count(
  ...
  iree_hal_hammerblade_descriptor_set_layout_t* descriptor_set_layout =
      iree_hal_hammerblade_descriptor_set_layout_cast(base_descriptor_set_layout);
  return descriptor_set_layout->binding_count;
}

static void iree_hal_hammerblade_descriptor_set_layout_destroy(
    iree_hal_descriptor_set_layout_t* base_descriptor_set_layout) {
  iree_hal_hammerblade_descriptor_set_layout_t* descriptor_set_layout =
      iree_hal_hammerblade_descriptor_set_layout_cast(base_descriptor_set_layout);
...
const iree_hal_descriptor_set_layout_vtable_t
    iree_hal_hammerblade_descriptor_set_layout_vtable = {
        .destroy = iree_hal_hammerblade_descriptor_set_layout_destroy,
};
