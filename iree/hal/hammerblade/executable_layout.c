...
typedef struct iree_hal_hammerblade_executable_layout_t {
  iree_hal_resource_t resource;
  iree_hal_hammerblade_context_wrapper_t* context;
  iree_host_size_t set_layout_count;
  iree_hal_descriptor_set_layout_t* set_layouts[];
} iree_hal_hammerblade_executable_layout_t;

extern const iree_hal_executable_layout_vtable_t
    iree_hal_hammerblade_executable_layout_vtable;

static iree_hal_hammerblade_executable_layout_t* iree_hal_hammerblade_executable_layout_cast(
    iree_hal_executable_layout_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_hal_hammerblade_executable_layout_vtable);
  return (iree_hal_hammerblade_executable_layout_t*)base_value;
}

iree_status_t iree_hal_hammerblade_executable_layout_create(
    iree_hal_hammerblade_context_wrapper_t* context,
    iree_host_size_t set_layout_count,
    iree_hal_descriptor_set_layout_t** set_layouts,
  ...
  *out_executable_layout = NULL;
  ...
  iree_hal_hammerblade_executable_layout_t* executable_layout = NULL;
  ...
  if (iree_status_is_ok(status)) {
    iree_hal_resource_initialize(&iree_hal_hammerblade_executable_layout_vtable,
...
static void iree_hal_hammerblade_executable_layout_destroy(
    iree_hal_executable_layout_t* base_executable_layout) {
  iree_hal_hammerblade_executable_layout_t* executable_layout =
      iree_hal_hammerblade_executable_layout_cast(base_executable_layout);
...
iree_host_size_t iree_hal_hammerblade_base_binding_index(
  ...
  for (iree_host_size_t i = 0; i < set; ++i) {
    iree_host_size_t binding_count =
        iree_hal_hammerblade_descriptor_set_layout_binding_count(
...
const iree_hal_executable_layout_vtable_t
    iree_hal_hammerblade_executable_layout_vtable = {
        .destroy = iree_hal_hammerblade_executable_layout_destroy,
};
