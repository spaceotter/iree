...
static iree_hal_hammerblade_buffer_t* iree_hal_hammerblade_buffer_cast(
    iree_hal_buffer_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_hal_hammerblade_buffer_vtable);
  return (iree_hal_hammerblade_buffer_t*)base_value;
}
...
iree_status_t iree_hal_hammerblade_buffer_wrap(
  ...
  iree_hal_hammerblade_buffer_t* buffer = NULL;
  iree_status_t status =
      iree_allocator_malloc(iree_hal_allocator_host_allocator(allocator),
                            sizeof(*buffer), (void**)&buffer);
  if (iree_status_is_ok(status)) {
    iree_hal_resource_initialize(&iree_hal_hammerblade_buffer_vtable,
...
static void iree_hal_hammerblade_buffer_destroy(iree_hal_buffer_t* base_buffer) {
  ...
  iree_hal_hammerblade_allocator_free(buffer->base.allocator, buffer->device_ptr,
...
static iree_status_t iree_hal_hammerblade_buffer_map_range(
...
static void iree_hal_hammerblade_buffer_unmap_range(
    iree_hal_buffer_t* base_buffer, iree_device_size_t local_byte_offset,
    iree_device_size_t local_byte_length, void* data_ptr) {
  // nothing to do.
}

static iree_status_t iree_hal_hammerblade_buffer_invalidate_range(
    iree_hal_buffer_t* base_buffer, iree_device_size_t local_byte_offset,
...
static iree_status_t iree_hal_hammerblade_buffer_flush_range(
    iree_hal_buffer_t* base_buffer, iree_device_size_t local_byte_offset,
    iree_device_size_t local_byte_length) {
  // Nothing to do.
  return iree_ok_status();
...
const iree_hal_buffer_vtable_t iree_hal_hammerblade_buffer_vtable = {
    .destroy = iree_hal_hammerblade_buffer_destroy,
    .map_range = iree_hal_hammerblade_buffer_map_range,
    .unmap_range = iree_hal_hammerblade_buffer_unmap_range,
    .invalidate_range = iree_hal_hammerblade_buffer_invalidate_range,
    .flush_range = iree_hal_hammerblade_buffer_flush_range,
};
