...
#include "iree/samples/rv_kernels/riscv_sigmoid/riscv_sigmoid_c.h"
...
#include "iree/samples/rv_kernels/riscv_sigmoid/riscv_sigmoid.h"
...
iree_status_t Run() {
  ...
  const struct iree_file_toc_t* module_file_toc =
      iree_samples_static_library_riscv_sigmoid_create();
  ...
  float kInput[] = {0.8f, 0.3f, 0.9f, 1.3f};
  float kExpectedOutput[] = {0.689974, 0.574442, 0.710949, 0.785835};
...
int main() {
  ...
  printf("static lib sigmoid run pass\n");
  return 0;
}
