...
#include "iree/samples/rv_kernels/riscv_sub/riscv_sub_c.h"
...
#include "iree/samples/rv_kernels/riscv_sub/riscv_sub.h"
...
iree_status_t Run() {
  ...
  const struct iree_file_toc_t* module_file_toc =
      iree_samples_static_library_riscv_sub_create();
...
int main() {
  ...
  printf("static lib sub run pass\n");
  return 0;
}
